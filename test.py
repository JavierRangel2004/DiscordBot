...
if __name__ == "__main__":
    ...
    directories_to_ignore = ["__pycache__", ".git", "node_modules"]  # Add directory names to ignore
    files_to_ignore = ["README.md", "LICENSE","output.txt",".env",".gitignore","package-lock.json","test.py"]  # Add file names to ignore
